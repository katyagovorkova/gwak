...
def main(timeslide_path, signal_path):
    ...
    timeslide_QUAK = timeslide_QUAK[p][:100000]
    timeslide_pearson = timeslide_pearson[p][:100000]
    ...
    ts = time.time()
    signal_QUAK = np.load(f"{signal_path}/signal_QUAK.npy")
    signal_pearson = np.load(f"{signal_path}/signal_pearson.npy")
...
timeslide_path = "/home/ryan.raikman/s22/anomaly/ES_savedir/"
path = "/home/ryan.raikman/s22/anomaly/ES_savedir_BBH_SG/"
main(timeslide_path, path)
